...
// Retained for non-R8 targets and as an in-source fallback/reference.  The R8
// build uses the generated ASCII-terminal pack included at the end of this file.
PROGMEM static const unsigned char classic_menu_icons[][66] = {
...
#ifdef MARAUDER_V8
  #include "SharkAsciiIcons.h"
#else
  #define menu_icons classic_menu_icons
#endif
