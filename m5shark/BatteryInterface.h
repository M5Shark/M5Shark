...
#ifdef HAS_AXP192
  #include "AXP192.h"
  // Declared here, defined once in BatteryInterface.cpp. Defining it in the
  // header gives it external linkage in every TU that includes this header,
  // which collides at link time as soon as more than one .cpp pulls it in.
