...
// SharkTheme.h / SharkTheme.cpp, which any file that draws must include.
#define SHARK_UI_NAME "SHARK"
  ...
  //// HARDWARE NAMES
    ...
    #define HARDWARE_NAME "M5 SHARK v8"
 ...
 //// BOARD FEATURES
  ...
  //// DISPLAY DEFINITIONS
      ...
      #define STATUSBAR_COLOR SHARK_PANEL
      ...
      //#define MENU_FONT &FreeSans9pt7b
      //#define MENU_FONT &FreeSansBold9pt7b
      // Four larger rows by two columns. The larger 51 px cells improve
      // readability and touch accuracy on the physical 2.8 inch display.
      ...
      // Length of the ctOS corner ticks drawn on every tile and button.
      #define SHARK_TICK_ARM 7
      // Taller icon HUD: still leaves the title and 2x4 tool grid untouched,
      // but gives 12 px status glyphs enough room for real-world readability.
